...
#widgets start from here
        ...
        self.btnadd.place(x=400,y=84)
        self.btnadd.bind('<Button-1>', self.add)
        self.btnsub = Button(win,text="Subtraction")
        self.btnsub.place(x=400,y=124)
        self.btnsub.bind('<Button-1>',self.sub)
        self.btnpro = Button(win,text="Multiplication")
        self.btnpro.place(x=400, y=164)
        self.btnpro.bind('<Button-1>', self.pro)
